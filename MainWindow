...
namespace Microsoft.Samples.Kinect.DepthBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        private unsafe void ProcessDepthFrameData(IntPtr depthFrameData, uint depthFrameDataSize, ushort minDepth, ushort maxDepth)
        {
            ...
            int totalSize = this.depthPixels.Length;
            int ratio;
            //int threshold = 100000; //num that represents a significanmt object is present at ____ dist.
            //Boolean vibrate = false;

            numDarkPixels = 0;
            //int count = 0;
            //int previousVal = 0;
            Console.WriteLine("processing the frame");
            ...
            for (int i = 0; i < (int)(depthFrameDataSize / this.depthFrameDescription.BytesPerPixel); ++i)
            {
                ...
                //Console.WriteLine(sum + " and " + total);
                // To convert to a byte, we're mapping the depth value to the byte range.
                // Values outside the reliable depth range are mapped to 0 (black).
                this.depthPixels[i] = (byte)(depth >= minDepth && depth <= maxDepth ? (depth / MapDepthToByte) : 0);
            }

            Console.WriteLine("Dark Pixels: " + numDarkPixels);
            //Console.WriteLine("Total Pixels: " + totalSize);
            //ratio = sum/217088;
            //Console.WriteLine("ratio of dark pixels to total:" + 5/9)
